...
local url = "https://mirrors.tuna.tsinghua.edu.cn/ubuntu-releases/16.04.1/ubuntu-16.04.1-server-amd64.iso"
...
local function main()
    ...
    local task = download.add(urls[1], "ubuntu-16.04-server-amd64.iso", urls)
    task:start()
